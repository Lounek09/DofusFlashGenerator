    ...
    public partial class MapFlashForm : Form, IFlashForm
    {
        ...
        public async Task AutoPlay(bool enable)
        {
            if (enable)
            {
                ...
                DialogResult dialogResult = MessageBox.Show("Do you want to screen automatically each map ?", "Question", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
        ...
        public void Screen()
        {
            ...
            string path = Path.Join(Constant.OUTPUT_MAPS_FOLDER_PATH, mapKey.Id + ".jpg");
